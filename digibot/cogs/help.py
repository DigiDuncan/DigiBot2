...
from digibot import __version__
...
class HelpCog(commands.Cog):
    ...
    async def send_summary_help(self, ctx):
        ...
        embeds = [discord.Embed(title=(f"Help [DigiBot {__version__}]" if n == 0 else None)) for n in range(embedCount)]
    ...
    async def send_command_help(self, ctx, cmd):
        ...
        ).set_author(name=f"Help [digibot {__version__}]")
    ...
    async def ping(self, ctx, subcommand: str = ""):
        ...
        Check DigiBot's current latency.
